...
> 이 부는 10페이지예요. 한 번만 읽어두시면 나머지 전부의 "왜"가 이해됩니다.
> 개별 요령을 백 개 외우는 것보다, 여기 있는 네 가지를 아는 편이 훨씬 편해요.
>
> 그리고 이 부를 읽고 나면 아마 이런 마음이 드실 겁니다.
> **"생각보다 해야 할 일이 적네."** 맞아요. 그게 이 부의 목적입니다.
...
> **이 회색 상자는 읽는 부분이 아닙니다.** 인쇄하거나 옮겨 적어 **벽에 붙이라고** 만든 한 장이에요.
> 급할 때는 책을 펼 수 없으니까요. 책 전체에 여덟 장 있고 (목록은 [이 책을 읽는 법](00-how-to-read.md)),
> 붙일 곳은 냉장고 문이든 아이 방문이든 손이 닿는 곳이면 됩니다.
