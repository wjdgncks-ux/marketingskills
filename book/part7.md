...
이 부는 **목록을 읽으며 우리 아이를 대조하게 되는 부분**입니다. 그러다 보면 거의 반드시 이런 순간이 와요. **"어? 우리 애 이거 안 하는데."**

그 순간을 위해 미리 말씀드릴게요.

**여기 적힌 것은 진단 기준이 아닙니다.** 하나 걸렸다고 문제가 있다는 뜻이 아니에요. 이 목록의 뜻은 딱 하나입니다 — **"이건 검색하지 말고 사람에게 물어보세요."** 그게 전부입니다.

그리고 순서를 하나 권해드릴게요. **38장을 먼저 보세요.** 부모가 걱정하지만 사실은 정상인 것 열두 가지가 거기 모여 있습니다. 많은 경우 지금 걱정하시는 게 그 안에 있어요.

38장에도 없고 37장에 걸린다면, 그때 하실 일은 걱정이 아니라 **예약**입니다. 확인해서 아무 일 아니면 그게 가장 좋은 결과고요.
...
> **이른둥이(조산아)는 교정연령으로 보세요.** 예정일보다 3주 이상 일찍 태어났다면, 아래 월령은 **예정일 기준**으로 계산합니다(대개 만 2세까지). 8주 일찍 태어난 생후 12개월 아기의 기준은 10개월입니다. 교정 없이 읽으면 정상 발달이 지연으로 보입니다.
