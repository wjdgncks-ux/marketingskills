...
| **시간순으로 보고 싶다** | 여는 글 다음의 **「첫 5년 타임라인」** — 시기마다 할 일·검진·물건이 한 표에 있습니다 |
...
| ✂️ **오려 쓰는 한 장** | 읽지 말고 **인쇄해 벽에 붙이는** 회색 상자 (아래 설명) | 미리 붙여두기 |

**세 줄로 줄이면**: 급할 땐 🚩, 오늘 뭘 할지 모르겠으면 🎯과 ✋, 다 읽기 싫으면 📌.

## ✂️ 「오려 쓰는 한 장」이 뭔가요

책 곳곳에 **회색 상자**가 나옵니다. 그건 **읽는 부분이 아니에요.**

**인쇄하거나 옮겨 적어서, 벽에 붙이라고 만든 한 장짜리 요약입니다.**

이유는 단순합니다 — **급할 때는 책을 펼 수 없거든요.** 새벽 두 시에 아이가 39℃로 열이 나는데 180쪽짜리 책의 목차를 뒤지고 있을 수는 없습니다. 그래서 그 순간에 필요한 것만 뽑아, **문에 붙여두는 형태**로 따로 만들었습니다.

붙일 곳은 **냉장고 문, 아이 방문, 시터가 보는 자리, 조부모 댁** — 손이 닿는 곳이면 어디든 좋습니다.

여덟 장이 본문 곳곳에 있고, 부록에 하나가 더 있어요.
...
예정일보다 3주 이상 일찍 태어났다면, 이 책의 발달 이정표(📊)와 월령별 장은 **태어난 날이 아니라 예정일 기준(교정연령)**으로 보세요. 8주 일찍 태어난 생후 6개월 아기는 **교정 4개월**로 읽는 게 맞습니다. 대개 만 2세까지 적용하고, 검진 때 조산 사실을 꼭 말하세요.
...
**한 문장으로**: 🚩는 꼭 보시고, ✂️는 인쇄해서 붙이시고, 나머지는 필요할 때 펴세요.
