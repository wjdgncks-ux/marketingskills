...
### ⚖️ 결론만 말하면 — 아이 사진, 어디까지 올려도 될까

- 올린 사진은 **지워도 회수되지 않는다**고 전제하는 게 안전합니다. 다운로드·캡처·재유포를 통제할 수 없습니다
- 최소한의 선: **알몸·목욕·배변 사진은 올리지 않기** · **위치가 드러나는 정보**(어린이집 이름, 집 앞)와 함께 올리지 않기 · 전체 공개 계정이라면 얼굴 노출을 줄이기
- 아이가 말을 알아들으면 **물어보고 올리는 습관**을 — "이 사진 올려도 돼?" 자기 몸의 주인이라는 감각은 온라인에서도 같습니다
- 조부모·친척 단체방 공유도 같은 기준입니다. **가족에게 우리 집 기준을 미리 알려두세요** (부록 G에 한 줄 추가해도 좋습니다)
