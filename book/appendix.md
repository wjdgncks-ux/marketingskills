...
미리 가방 하나에 모아두면 새벽에 3분 안에 나갈 수 있습니다.

- [ ] **아기수첩(예방접종 기록)** · 신분증
- [ ] **먹는 약 전부** (사진으로 찍어둬도 됩니다)
- [ ] 최근에 먹인 **해열제 이름·용량·시각 메모**
- [ ] 기저귀 3~4개 · 물티슈 · 여벌 옷 한 벌
- [ ] 수유용품(분유·젖병) 또는 간단한 간식
- [ ] 휴대폰 충전기 · 애착 인형
- [ ] 가능하면 **어른 한 명 더** — 한 명은 아이를, 한 명은 접수·설명을
...
**힘든 게 정상입니다.**
잠을 못 자서 판단이 흐려지고, 아이 울음에 화가 나고, 어떤 날은 아이가 밉기도 할 거예요. 그건 당신이 나쁜 부모라는 뜻이 아니라, **사람이 감당하기 벅찬 일을 하고 있다는 뜻**입니다.

**실수는 회복으로 갚으면 됩니다.**
소리를 질렀다면 사과하세요. 그 과정이 아이에게 "관계는 깨져도 고칠 수 있다"를 가르칩니다. 한 번도 어긋나지 않은 관계에서는 배울 수 없는 것이에요.

**그리고 이 모든 시기는 지나갑니다.**
지금 끝나지 않을 것 같은 밤도, 6주쯤 지나면 다르게 느껴질 거예요. 지금 하루에 열 번 떼쓰는 아이도, 몇 달 뒤엔 문장으로 자기 마음을 말하게 됩니다.
